...
git remote add origin https://${GITHUB_USERNAME}:${GITHUB_TOKEN}@github.com/${GITHUB_USERNAME}/DAC2.git
...
echo "✅ Setup complete! Your code has been pushed to https://github.com/${GITHUB_USERNAME}/DAC2"
